...
#import "SavedPageTitleAttributedString.h"
...
static NSString* const kWMFSavedPagesCellID                   = @"SavedPagesResultCell";
...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"SavedPagesResultPrototypeView" bundle:nil] forCellReuseIdentifier:kWMFSavedPagesCellID];
    ...
    self.offScreenSizingCell = (SavedPagesResultCell*)[self.tableView dequeueReusableCellWithIdentifier:kWMFSavedPagesCellID];
}
...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath {
    SavedPagesResultCell* cell = (SavedPagesResultCell*)[tableView dequeueReusableCellWithIdentifier:kWMFSavedPagesCellID];
...
- (NSAttributedString*)getAttributedStringForArticle:(MWKArticle*)article {
    return [SavedPageTitleAttributedString attributedStringWithTitle:article.title.prefixedText
...
- (CGFloat)tableView:(UITableView*)tableView heightForRowAtIndexPath:(NSIndexPath*)indexPath {
    ...
    CGFloat height = [tableView heightForSizingCell:self.offScreenSizingCell];
