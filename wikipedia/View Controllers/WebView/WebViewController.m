...
- (void)viewDidLoad {
    ...
    [self.bridge addListener:@"DOMContentLoaded" withBlock:^(NSString* type, NSDictionary* payload) {
        ...
        [weakSelf.loadingIndicatorOverlay setHidden:YES animated:YES];
...
- (void)tocShow {
    ...
    if (!self.loadingIndicatorOverlay.hidden) {
        return;
    }
...
- (void)  navigateToPage:(MWKTitle*)title
    ...
    if (showLoadingIndicator) {
        ...
        [self.loadingIndicatorOverlay setHidden:NO animated:YES];
    }
    ...
    if ([sender isKindOfClass:[ArticleFetcher class]]) {
        ...
        switch (status) {
            ...
            case FETCH_FINAL_STATUS_FAILED:
            {
                ...
                [self.loadingIndicatorOverlay setHidden:YES animated:YES];
...
- (void)loadingIndicatorAdd {
    ...
    self.loadingIndicatorOverlay.animationDuration = 0.33f;
