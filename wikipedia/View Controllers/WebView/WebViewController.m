...
- (void)displayArticle:(MWKTitle *)title
{
    ...
    if (![[SessionSingleton sharedInstance] isCurrentArticleMain]) {
        ...
        self.footerViewController.searchString = article.title.text;
        self.footerViewController.articlesToExcludeFromResults = @[article];
        [self.footerViewController search];
