...
public class WelcomeIntroAnimationView : UIView {
    ...
    override public func didMoveToSuperview() {
        ...
        let tubeRotationPoint = CGPointMake(0.575,  0.3821)

        let initialTubeRotationTransform = CATransform3D.wmf_rotationWithAngleDegrees(-25.0)
        ...
        self.star1 = WelcomePlusShapeLayer(
            unitPoint: CGPointMake(0.033, 0.219),
            unitWidth: 0.05,
            referenceSize: self.frame.size,
            transform: scaleZeroTransform,
            opacity: 0.0
        ...
        self.star2 = WelcomePlusShapeLayer(
            unitPoint: CGPointMake(0.11, 0.16),
            unitWidth: 0.05,
            referenceSize: self.frame.size,
            transform: scaleZeroTransform,
            opacity: 0.0
        ...
        self.line1 = WelcomeLineShapeLayer(
            unitPoint: CGPointMake(0.91, 0.778),
            unitWidth: 0.144,
            referenceSize: self.frame.size,
        ...
        self.line2 = WelcomeLineShapeLayer(
            unitPoint: CGPointMake(0.836, 0.81),
            unitWidth: 0.06,
            referenceSize: self.frame.size,
            transform: linesTransform,
            opacity: 0.0
        ...
        self.line3 = WelcomeLineShapeLayer(
            unitPoint: CGPointMake(0.907, 0.81),
            unitWidth: 0.0125,
            referenceSize: self.frame.size,
            transform: linesTransform,
            opacity: 0.0
    ...
    public func beginAnimations() {
        ...
        let tubeOvershootRotationTransform = CATransform3D.wmf_rotationWithAngleDegrees(10.0)
        let tubeFinalRotationTransform = CATransform3D.wmf_rotationWithAngleDegrees(5.0)
