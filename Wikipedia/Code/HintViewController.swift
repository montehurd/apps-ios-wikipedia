...
class HintViewController: UIViewController {
    ...
    @IBOutlet weak var warningSublabel: UILabel!
    ...
    private func updateFonts() {
        ...
        warningSublabel.font = UIFont.wmf_font(.caption1, compatibleWithTraitCollection: traitCollection)
    }
}
...
extension HintViewController: Themeable {
    func apply(theme: Theme) {
        ...
        warningSublabel?.textColor = primaryColor ?? theme.colors.primaryText
    }
}
