...
public class WelcomeAnalyticsAnimationView : UIView {
    ...
    var star1: WelcomePlusShapeLayer?
    var star2: WelcomePlusShapeLayer?
    ...
    override public func didMoveToSuperview() {
        ...
        let leftTransform = CATransform3DMakeTranslation(-50, 0, 0)
        let rightTransform = CATransform3DMakeTranslation(50, 0, 0)
        ...
        bar1?.transform = squashedHeightTransform
        bar2?.transform = squashedHeightTransform
        bar3?.transform = squashedHeightTransform
        bar4?.transform = squashedHeightTransform
        bar5?.transform = squashedHeightTransform
        ...
        self.star1 = WelcomePlusShapeLayer(
            unitPoint: CGPointMake(0.9, 0.222),
            unitWidth: 0.05,
            referenceSize: self.frame.size,
            transform: scaleZeroTransform,
            opacity: 0.0
        )
        self.layer.addSublayer(self.star1!)

        self.star2 = WelcomePlusShapeLayer(
            unitPoint: CGPointMake(0.832, 0.167),
            unitWidth: 0.05,
            referenceSize: self.frame.size,
            transform: scaleZeroTransform,
            opacity: 0.0
        )
        self.layer.addSublayer(self.star2!)

        self.line1 = WelcomeLineShapeLayer(
            unitPoint: CGPointMake(0.82, 0.778),
            unitWidth: 0.125,
            referenceSize: self.frame.size,
        ...
        self.line2 = WelcomeLineShapeLayer(
            unitPoint: CGPointMake(0.775, 0.736),
            unitWidth: 0.127,
            referenceSize: self.frame.size,
            transform: linesLeftTransform,
            opacity: 0.0
        ...
        self.line3 = WelcomeLineShapeLayer(
            unitPoint: CGPointMake(0.233, 0.385),
            unitWidth: 0.043,
            referenceSize: self.frame.size,
        ...
        self.line4 = WelcomeLineShapeLayer(
            unitPoint: CGPointMake(0.17, 0.385),
            unitWidth: 0.015,
            referenceSize: self.frame.size,
            transform: linesRightTransform,
            opacity: 0.0
        ...
        self.line5 = WelcomeLineShapeLayer(
            unitPoint: CGPointMake(0.11, 0.427),
            unitWidth: 0.043,
            referenceSize: self.frame.size,
            transform: linesRightTransform,
            opacity: 0.0
        ...
        self.line6 = WelcomeLineShapeLayer(
            unitPoint: CGPointMake(0.173, 0.427),
            unitWidth: 0.015,
            referenceSize: self.frame.size,
            transform: linesRightTransform,
            opacity: 0.0
