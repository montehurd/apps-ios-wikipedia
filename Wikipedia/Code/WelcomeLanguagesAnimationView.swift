...
public class WelcomeLanguagesAnimationView : UIView {
    ...
    var star3: WelcomePlusShapeLayer?
    ...
    override public func didMoveToSuperview() {
        ...
        let lowerLeftTransform = CATransform3DMakeTranslation(-50, 50, 0)
        let lowerRightTransform = CATransform3DMakeTranslation(50, 50, 0)
        ...
        self.star1 = WelcomePlusShapeLayer(
            unitPoint: CGPointMake(0.825, 0.225),
            unitWidth: 0.05,
            referenceSize: self.frame.size,
            transform: scaleZeroTransform,
            opacity: 0.0
        ...
        self.star2 = WelcomePlusShapeLayer(
            unitPoint: CGPointMake(0.755, 0.17),
            unitWidth: 0.05,
            referenceSize: self.frame.size,
            transform: scaleZeroTransform,
            opacity: 0.0
        ...
        self.star3 = WelcomePlusShapeLayer(
            unitPoint: CGPointMake(0.112, 0.353),
            unitWidth: 0.05,
            referenceSize: self.frame.size,
            transform: scaleZeroTransform,
            opacity: 0.0
        )
        self.layer.addSublayer(self.star3!)
        
        self.line1 = WelcomeLineShapeLayer(
            unitPoint: CGPointMake(0.845, 0.865),
            unitWidth: 0.135,
            referenceSize: self.frame.size,
        ...
        self.line2 = WelcomeLineShapeLayer(
            unitPoint: CGPointMake(0.255, 0.162),
            unitWidth: 0.135,
            referenceSize: self.frame.size,
            transform: linesTransform,
            opacity: 0.0
        ...
        self.line3 = WelcomeLineShapeLayer(
            unitPoint: CGPointMake(0.205, 0.127),
            unitWidth: 0.135,
            referenceSize: self.frame.size,
            transform: linesTransform,
            opacity: 0.0
