...
NSURL *articleURL = [NSURL URLWithString: @"https://en.wikipedia.org/wiki/Tamarack,_Minnesota"];
MWKArticle *article = [[[SessionSingleton sharedInstance] dataStore] articleWithURL:articleURL];
id jsonData = [WMFArticleJSONCompilationHelper reconstructMobileViewJSONFor:article imageSize: CGSizeMake(640, 640)];
