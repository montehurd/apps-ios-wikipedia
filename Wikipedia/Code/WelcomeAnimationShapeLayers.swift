...
public class WelcomeBarShapeLayer : WelcomeShapeLayer {
    public required init(unitRect: CGRect, referenceSize: CGSize) {
        super.init()
...
public class WelcomeCircleShapeLayer : WelcomeShapeLayer {
    public required init(unitRadius: CGFloat, unitOrigin:CGPoint, referenceSize: CGSize, isDashed: Bool, transform: CATransform3D, opacity: CGFloat) {
        ...
        self.lineWidth = referenceSize.width * 0.014
...
public class WelcomePlusShapeLayer : WelcomeShapeLayer {
    public required init(unitPoint: CGPoint, unitWidth: CGFloat, referenceSize: CGSize, transform: CATransform3D, opacity: CGFloat) {
        super.init()
        self.position = unitPoint.wmf_denormalizeUsingSize(referenceSize)
