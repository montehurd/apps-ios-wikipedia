...
-(void)didReceiveMemoryWarning {
    ...
    WMFTrendingViewController* trendingVC = [[WMFTrendingViewController alloc] initWithSite:[SessionSingleton sharedInstance].searchSite date:[NSDate date] dataStore:self.dataStore];
