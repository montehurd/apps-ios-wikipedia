...
//    fileprivate var captchaId: NSString? = ""
    ...
    fileprivate func createAccount(withCaptcha captcha:String) {
        WMFAuthenticationManager.sharedInstance().createAccount(withUsername: usernameField.text!, password: passwordField.text!, retypePassword: passwordRepeatField.text!, email: emailField.text!, captchaText: captcha, captchaID:captchaID, captchaImageURL:nil, success: {
