...
transformer.register( 'displayDisambigLink', function( content ) {
    ...
    if ( hatnotes.length > 0 ) {
        ...
        link.innerHTML = transformer.httpGet('wmf://localize/page-similar-titles');
...
transformer.register( 'displayIssuesLink', function( content ) {
    ...
    if ( issues.length > 0 ) {
        ...
        link.innerHTML = transformer.httpGet('wmf://localize/page-issues');
...
transformer.register( "hideTables", function( content ) {
    ...
    for (var i = 0; i < tables.length; i++) {
        ...
        var caption = "<strong>" + (isInfobox ? transformer.httpGet('wmf://localize/info-box-title') : transformer.httpGet('wmf://localize/table-title-other')) + "</strong>";
        ...
        bottomDiv.innerHTML = transformer.httpGet('wmf://localize/info-box-close-text');
