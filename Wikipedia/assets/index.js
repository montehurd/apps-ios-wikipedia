...
window.wmf = wmf
},{"./js/elementLocation":3,"./js/findInPage":4,"./js/sectionTransformation":6,"./js/transforms/addEditButtons":7,"./js/transforms/collapseTables":8,"./js/transforms/disableFilePageEdit":9,"./js/transforms/relocateFirstParagraph":10,"./js/transforms/widenImages":11,"./js/utilities":12,"wikimedia-page-library":14}],2:[function(require,module,exports){
...
/*
 - modify image urls to proxy not by parsing on native side but by using JS transforms once we have doc frag? (they're already parsed anyway)
 - could we prototype any missing fragment objects if a transforms calls something on frag which only exits in document?
 - switch TOC to ask webview for sections (so when things are hidden in web view the TOC won't show them)?
 - handle lead section
 - do getHTMLWrappedInTablesIfNeeded?
 - make sure this works - (void)loadHTMLFromAssetsFile:(NSString *)fileName scrolledToFragment:(NSString *)fragment {
 - use updated from these branches
    remove-css-cruft
...
},{"wikimedia-page-library":14}],7:[function(require,module,exports){
