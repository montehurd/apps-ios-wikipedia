...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var NodeTypes={ELEMENT_NODE:1,TEXT_NODE:3,PROCESSING_INSTRUCTION_NODE:7,COMMENT_NODE:8,DOCUMENT_NODE:9,DOCUMENT_TYPE_NODE:10,DOCUMENT_FRAGMENT_NODE:11};var isNodeTypeElementOrText=function isNodeTypeElementOrText(node){return node.nodeType===NodeTypes.ELEMENT_NODE||node.nodeType===NodeTypes.TEXT_NODE;};exports.default={isNodeTypeElementOrText:isNodeTypeElementOrText,NodeTypes:NodeTypes};
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _ThemeTransform=__webpack_require__(12);var _ThemeTransform2=_interopRequireDefault(_ThemeTransform);var _CollapseTable=__webpack_require__(3);var _CollapseTable2=_interopRequireDefault(_CollapseTable);var _CollectionUtilities=__webpack_require__(5);var _CollectionUtilities2=_interopRequireDefault(_CollectionUtilities);var _CompatibilityTransform=__webpack_require__(15);var _CompatibilityTransform2=_interopRequireDefault(_CompatibilityTransform);var _DimImagesTransform=__webpack_require__(16);var _DimImagesTransform2=_interopRequireDefault(_DimImagesTransform);var _EditTransform=__webpack_require__(18);var _EditTransform2=_interopRequireDefault(_EditTransform);var _ElementGeometry=__webpack_require__(6);var _ElementGeometry2=_interopRequireDefault(_ElementGeometry);var _ElementUtilities=__webpack_require__(1);var _ElementUtilities2=_interopRequireDefault(_ElementUtilities);var _LeadIntroductionTransform=__webpack_require__(20);var _LeadIntroductionTransform2=_interopRequireDefault(_LeadIntroductionTransform);var _FooterContainer=__webpack_require__(7);var _FooterContainer2=_interopRequireDefault(_FooterContainer);var _FooterLegal=__webpack_require__(8);var _FooterLegal2=_interopRequireDefault(_FooterLegal);var _FooterMenu=__webpack_require__(23);var _FooterMenu2=_interopRequireDefault(_FooterMenu);var _FooterReadMore=__webpack_require__(9);var _FooterReadMore2=_interopRequireDefault(_FooterReadMore);var _FooterTransformer=__webpack_require__(26);var _FooterTransformer2=_interopRequireDefault(_FooterTransformer);var _LazyLoadTransform=__webpack_require__(10);var _LazyLoadTransform2=_interopRequireDefault(_LazyLoadTransform);var _LazyLoadTransformer=__webpack_require__(28);var _LazyLoadTransformer2=_interopRequireDefault(_LazyLoadTransformer);var _PlatformTransform=__webpack_require__(29);var _PlatformTransform2=_interopRequireDefault(_PlatformTransform);var _Polyfill=__webpack_require__(0);var _Polyfill2=_interopRequireDefault(_Polyfill);var _RedLinks=__webpack_require__(30);var _RedLinks2=_interopRequireDefault(_RedLinks);var _ReferenceCollection=__webpack_require__(31);var _ReferenceCollection2=_interopRequireDefault(_ReferenceCollection);var _Throttle=__webpack_require__(2);var _Throttle2=_interopRequireDefault(_Throttle);var _WidenImage=__webpack_require__(32);var _WidenImage2=_interopRequireDefault(_WidenImage);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={CollapseTable:_CollapseTable2.default,CollectionUtilities:_CollectionUtilities2.default,CompatibilityTransform:_CompatibilityTransform2.default,DimImagesTransform:_DimImagesTransform2.default,EditTransform:_EditTransform2.default,LeadIntroductionTransform:_LeadIntroductionTransform2.default,FooterContainer:_FooterContainer2.default,FooterLegal:_FooterLegal2.default,FooterMenu:_FooterMenu2.default,FooterReadMore:_FooterReadMore2.default,FooterTransformer:_FooterTransformer2.default,LazyLoadTransform:_LazyLoadTransform2.default,LazyLoadTransformer:_LazyLoadTransformer2.default,PlatformTransform:_PlatformTransform2.default,RedLinks:_RedLinks2.default,ReferenceCollection:_ReferenceCollection2.default,ThemeTransform:_ThemeTransform2.default,WidenImage:_WidenImage2.default,test:{ElementGeometry:_ElementGeometry2.default,ElementUtilities:_ElementUtilities2.default,Polyfill:_Polyfill2.default,Throttle:_Throttle2.default}};
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});__webpack_require__(17);var CLASS='pagelib_dim_images';var dim=function dim(window,enable){window.document.querySelector('html').classList[enable?'add':'remove'](CLASS);};var isDim=function isDim(window){return window.document.querySelector('html').classList.contains(CLASS);};exports.default={CLASS:CLASS,isDim:isDim,dim:dim};
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _ElementUtilities=__webpack_require__(1);var _ElementUtilities2=_interopRequireDefault(_ElementUtilities);var _NodeUtilities=__webpack_require__(4);var _NodeUtilities2=_interopRequireDefault(_NodeUtilities);var _Polyfill=__webpack_require__(0);var _Polyfill2=_interopRequireDefault(_Polyfill);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var NodeTypes=_NodeUtilities2.default.NodeTypes;var REFERENCE_SELECTOR='.reference';var isCitation=function isCitation(href){return href.indexOf('#cite_note')>-1;};var isEndnote=function isEndnote(href){return href.indexOf('#endnote_')>-1;};var isReference=function isReference(href){return href.indexOf('#ref_')>-1;};var goDown=function goDown(element){return element.querySelector('A');};var isWhitespaceTextNode=function isWhitespaceTextNode(node){return!(!node||node.nodeType!==NodeTypes.TEXT_NODE||!node.textContent.match(/^\s+$/));};var hasCitationLink=function hasCitationLink(element){try{return isCitation(goDown(element).getAttribute('href'));}catch(e){return false;}};var getRefTextContainer=function getRefTextContainer(document,sourceNode){var currentNode=sourceNode;if(currentNode.tagName!=='A'){currentNode=goDown(currentNode);}var refTextContainerID=currentNode.getAttribute('href').slice(1);var refTextContainer=document.getElementById(refTextContainerID)||document.getElementById(decodeURIComponent(refTextContainerID));return refTextContainer;};var collectRefText=function collectRefText(document,sourceNode){var refTextContainer=getRefTextContainer(document,sourceNode);if(!refTextContainer){return'';}var frag=document.createDocumentFragment();var fragDiv=document.createElement('div');frag.appendChild(fragDiv);var cloneNodeIntoFragmentDiv=function cloneNodeIntoFragmentDiv(node){return fragDiv.appendChild(node.cloneNode(true));};Array.prototype.slice.call(refTextContainer.childNodes).filter(_NodeUtilities2.default.isNodeTypeElementOrText).forEach(cloneNodeIntoFragmentDiv);var removalSelector='sup[id^=cite_ref], .mw-cite-backlink';_Polyfill2.default.querySelectorAll(fragDiv,removalSelector).forEach(function(node){return node.remove();});return fragDiv.innerHTML;};var collectRefLink=function collectRefLink(sourceNode){if(_Polyfill2.default.matchesSelector(sourceNode,REFERENCE_SELECTOR)){return sourceNode;}return _ElementUtilities2.default.findClosestAncestor(sourceNode,REFERENCE_SELECTOR);};var ReferenceItem=function ReferenceItem(id,rect,text,html){_classCallCheck(this,ReferenceItem);this.id=id;this.rect=rect;this.text=text;this.html=html;};var referenceItemForNode=function referenceItemForNode(document,node){return new ReferenceItem(collectRefLink(node).id,node.getBoundingClientRect(),node.textContent,collectRefText(document,node));};var NearbyReferences=function NearbyReferences(selectedIndex,referencesGroup){_classCallCheck(this,NearbyReferences);this.selectedIndex=selectedIndex;this.referencesGroup=referencesGroup;};var adjacentNonWhitespaceNode=function adjacentNonWhitespaceNode(node,siblingGetter){var currentNode=node;do{currentNode=siblingGetter(currentNode);}while(isWhitespaceTextNode(currentNode));return currentNode;};var collectAdjacentReferenceNodes=function collectAdjacentReferenceNodes(parent,siblingGetter,collectedNodesCollector){var currentNode=parent;while(true){currentNode=adjacentNonWhitespaceNode(currentNode,siblingGetter);if(hasCitationLink(currentNode)){collectedNodesCollector(currentNode);}else{break;}}};var collectNearbyReferenceNodes=function collectNearbyReferenceNodes(sourceNode){var collectedNodes=[sourceNode];var parent=sourceNode.parentElement;var prevSiblingGetter=function prevSiblingGetter(node){return node.previousSibling;};var nextSiblingGetter=function nextSiblingGetter(node){return node.nextSibling;};var collectedNodesUnshifter=function collectedNodesUnshifter(node){return collectedNodes.unshift(node);};var collectedNodesPusher=function collectedNodesPusher(node){return collectedNodes.push(node);};collectAdjacentReferenceNodes(parent,prevSiblingGetter,collectedNodesUnshifter);collectAdjacentReferenceNodes(parent,nextSiblingGetter,collectedNodesPusher);return collectedNodes;};var collectNearbyReferences=function collectNearbyReferences(document,sourceNode){var referenceNodes=collectNearbyReferenceNodes(sourceNode);var selectedIndex=referenceNodes.indexOf(sourceNode);var referencesGroup=referenceNodes.map(function(node){return referenceItemForNode(document,node);});return new NearbyReferences(selectedIndex,referencesGroup);};exports.default={collectNearbyReferences:collectNearbyReferences,isCitation:isCitation,isEndnote:isEndnote,isReference:isReference,test:{collectNearbyReferenceNodes:collectNearbyReferenceNodes}};
...
window.wmf = wmf
},{"./js/elementLocation":4,"./js/findInPage":5,"./js/footers":6,"./js/sections":7,"./js/utilities":8,"wikimedia-page-library":1}],3:[function(require,module,exports){
...
},{"./utilities":8,"wikimedia-page-library":1}],4:[function(require,module,exports){
...
},{"./elementLocation":4,"./utilities":8,"wikimedia-page-library":1}],8:[function(require,module,exports){
