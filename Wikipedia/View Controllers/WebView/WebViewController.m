...
@interface WebViewController () <LanguageSelectionDelegate, WMFWebViewFooterContainerHeightChanged>
...
- (void)setupTrackingFooter {
    if (!self.footerContainer) {
        ...
        self.footerContainer.heightChangedDelegate = self;
...
- (void)nativeFooterContainerHeightChanged:(id)sender
    ...
    [self updateFooterPlaceholderDivHeight:height];
}
