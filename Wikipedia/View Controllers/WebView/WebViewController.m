...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(updateFooterPlaceholderDivHeight)
                                                 name:@"WMFFooterViewControllerViewHeightChanged" object:nil];
...
- (void)displayArticle:(MWKTitle*)title {
    ...
    [sectionTextArray addObject:@"<div id='bottom_native_footer_spacer' style='background-color:white;'></div>"];
...
- (void)updateFooterPlaceholderDivHeight {
    [self.webView stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"document.getElementById('bottom_native_footer_spacer').style.height = '%fpx';", self.footerContainer.intrinsicContentSize.height]];
}
